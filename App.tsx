...
import { INITIAL_GREETING, MODE_DESCRIPTIONS, TEACHER_NAME, TEACHER_SCHOOL } from './constants';
      ...
      <main className="flex-1 flex flex-col h-full relative w-full bg-background-light dark:bg-background-dark transition-colors duration-200">
        ...
        <header className="bg-surface-light dark:bg-surface-dark shadow-sm px-4 py-3 flex items-center justify-between z-20 sticky top-0 transition-colors duration-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-base font-bold leading-tight text-gray-900 dark:text-white">{TEACHER_NAME}</h1>
            ...
            <div className="flex items-start space-x-3">
              <div className="flex-1">
                <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mb-2">
                  ...
                  <span>GV Tin học - {TEACHER_SCHOOL}</span>
                </div>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-1 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-[10px] font-bold uppercase rounded-lg border border-green-100 dark:border-green-800">Tin học 6-12</span>
                  <span className="px-2 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-[10px] font-bold uppercase rounded-lg border border-blue-100 dark:border-blue-800">Vui vẻ</span>
                </div>
              </div>
              <button
